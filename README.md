...
**Disclaimer: this repository is intended for internal use within the Zhuang Group at Princeton and is not purposed as a general guide.**

## Contact

For any question regarding TPU usage, please add **and** message Boya Zeng on [Messenger](https://www.facebook.com/boya.zeng.2025/).
...
[requirements.txt](requirements.txt): environment setup for MNIST training.
